...
/**
 * [android.view.View.onClickListener] used to translate the product grid sheet download on
	...
	private fun updateIcon(view: View) {
		if (openIcon != null && closeIcon != null) {
			if (view !is ImageView) {
				throw IllegalArgumentException("updateIcon()mustbe called on an ImageView")
			}
			if (backdropShown) {
